...
<div class="notice"><b>Version 5:</b> English uses a single-speaker US English Piper voice. Lesson audio is cached as WAV after the first generation, so the same phrase can be replayed without synthesizing it again.</div>`;}
