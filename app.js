...
<div class="notice"><b>Version 5.1:</b> English uses Kokoro neural US English. Lesson audio is cached as WAV after the first generation, so the same phrase can be replayed without synthesizing it again.</div>`;}
